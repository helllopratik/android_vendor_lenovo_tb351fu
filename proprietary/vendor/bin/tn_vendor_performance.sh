...
function configure_memory_parameters() {
	...
	echo 54000 > /proc/sys/vm/min_free_kbytes
	echo 55 > /proc/sys/vm/watermark_scale_factor  #60

	echo 100 > /proc/sys/vm/swappiness  #160

	echo 10 > /proc/sys/vm/dirty_background_ratio #10
